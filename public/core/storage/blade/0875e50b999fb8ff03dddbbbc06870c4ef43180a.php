...
<?php $__env->startSection('content'); ?>
    ...
    <form class="htmlsnippet" id="mutate" name="mutate" method="post" action="index.php">
        ...
        <h1>
            <i class="<?php echo e($_style['icon_chunk']); ?>"></i>
            <?php if($data->name): ?>
...
<?php echo $__env->make('manager::template.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/public/manager//views//page/chunk.blade.php ENDPATH**/ ?>