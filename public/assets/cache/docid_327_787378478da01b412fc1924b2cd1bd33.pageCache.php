...
<html dir="ltr" lang="en-us">
	<head>
		...
		<title>Evgeniy Pavlov | View. Theories and Practices of Visual Culture</title>
		...
		<meta itemprop="name" content="Evgeniy Pavlov | View. Theories and Practices of Visual Culture">
		<meta itemprop="description" content="">
		<meta itemprop="image" content="https://www.pismowidok.org/og-image-1200x630.jpg">

		<!-- Twitter Card -->
		<meta name="twitter:card" value="summary">
		<meta name="twitter:title" content="Evgeniy Pavlov | View. Theories and Practices of Visual Culture">
		...
		<meta property="og:title" content="Evgeniy Pavlov | View. Theories and Practices of Visual Culture">
        ...
        <div class="c-headertools">
          <ul>
            <li class="c-headertools__lang">
							<a class="c-headertools__lang-link u-underline-border" href="/pl/bio?id=824"><span>PL</span></a>
			...
			<div class="content-canvas__inner">
				...
				<div class="c-team">
					...
					<div class="c-team__desc">
						<h1 class="c-team__title">Evgeniy Pavlov</h1>
						<p class="c-team__meta">
							
						</p>
						<div class="u-typo" style="margin-top: 2em;">
							<p>Evgeniy Pavlov (b. 1949) - Ukrainian photographer, one of the most prominent representatives of the so-called Kharkiv Photography School. In 1971, he established with Yuriy Rupin the artistic group "Time" (with Boris Mikhailov as leader). His main projects - <em>Total Photography</em>, <em>Archive Series</em> and <em>Parnography</em> - were shown in museums and galleries in USA and Eastern Europe. Recently he published two photographic books: <em>Home Life Book</em> (<em>дом быта</em>, 2013) and <em>Total Photography</em> (<em>Tоmaльнa фomoгpaфiя</em>, 2016).</p>
						</div>
					</div>
				</div>
