...
<html dir="ltr" lang="pl">
	<head>
		...
		<title>Dorota Sosnowska | Widok. Teorie i Praktyki Kultury Wizualnej</title>
		...
		<meta itemprop="name" content="Dorota Sosnowska | Widok. Teorie i Praktyki Kultury Wizualnej">
		<meta itemprop="description" content="">
		<meta itemprop="image" content="https://www.pismowidok.org/og-image-1200x630.jpg">

		<!-- Twitter Card -->
		<meta name="twitter:card" value="summary">
		<meta name="twitter:title" content="Dorota Sosnowska | Widok. Teorie i Praktyki Kultury Wizualnej">
		...
		<meta property="og:title" content="Dorota Sosnowska | Widok. Teorie i Praktyki Kultury Wizualnej">
        ...
        <div class="c-headertools">
          <ul>
            <li class="c-headertools__lang">
							<a class="c-headertools__lang-link u-underline-border" href="/en/bio?id=731"><span>EN</span></a>
...
<section>
			...
			<div class="content-canvas__inner">
				...
				<div class="c-team">
					...
					<div class="c-team__desc">
						<h1 class="c-team__title">Dorota Sosnowska</h1>
	...
	<a target="_blank" href="http://ikp.uw.edu.pl/dr-dorota-sosnowska/">Instytut Kultury Polskiej, Uniwersytet Warszawski</a>
	
	
</span>
						</p>
						<div class="u-typo" style="margin-top: 2em;">
							<p>Ur. 1982. Adiunktka w Zakładzie Teatru i Widowisk Instytutu Kultury Polskiej UW. Interesuje się zagadnieniami związanymi z teatrem i performansem, szczególnie w perspektywie dokumentacji, pamięci i archiwum. Autorka książki <em>Królowe PRL. Sceniczne wizerunki Ireny Eichlerówny, Niny Andrycz i Elżbiety Barszczewskiej jako modele kobiecości</em> (2014). Zaangażowana w projekty naukowe związane z tematyką dokumentacji i jej medialności („Źródła i mediacje”), przedmiotu performatywnego („Maska w kulturze współczesnej Europy”) oraz performansu i pamięci („Performanse pamięci”). </p>
						</div>
					</div>
				</div>
