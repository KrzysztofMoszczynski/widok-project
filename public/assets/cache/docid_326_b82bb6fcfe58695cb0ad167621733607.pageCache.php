...
<html dir="ltr" lang="pl">
	<head>
		...
		<title>Konsorcjum Praktyk Postartystycznych | Widok. Teorie i Praktyki Kultury Wizualnej</title>
		...
		<meta itemprop="name" content="Konsorcjum Praktyk Postartystycznych | Widok. Teorie i Praktyki Kultury Wizualnej">
		<meta itemprop="description" content="">
		<meta itemprop="image" content="https://www.pismowidok.org/og-image-1200x630.jpg">

		<!-- Twitter Card -->
		<meta name="twitter:card" value="summary">
		<meta name="twitter:title" content="Konsorcjum Praktyk Postartystycznych | Widok. Teorie i Praktyki Kultury Wizualnej">
		...
		<meta property="og:title" content="Konsorcjum Praktyk Postartystycznych | Widok. Teorie i Praktyki Kultury Wizualnej">
        ...
        <div class="c-headertools">
          <ul>
            <li class="c-headertools__lang">
							<a class="c-headertools__lang-link u-underline-border" href="/en/bio?id=637"><span>EN</span></a>
			...
			<div class="content-canvas__inner">
				...
				<div class="c-team">
					...
					<div class="c-team__desc">
						<h1 class="c-team__title">Konsorcjum Praktyk Postartystycznych</h1>
						<p class="c-team__meta">
							
						</p>
						<div class="u-typo" style="margin-top: 2em;">
							<p>Nieformalny i interdyscyplinarny sojusz ludzi sztuki, którzy używają swojej wyobraźni i umiejętności artystycznych poza polem sztuki. Angażują się w koalicje antyfaszystowskie, walczą o prawa kobiet, artystek i pracowniczek. Celem działalności Konsorcjum jest mobilizacja, wymiana idei, dystrybucja informacji, sieciowanie.</p>
						</div>
					</div>
				</div>
