...
<html dir="ltr" lang="pl">
	<head>
		...
		<title>Sammy Baloji | Widok. Teorie i Praktyki Kultury Wizualnej</title>
		...
		<meta itemprop="name" content="Sammy Baloji | Widok. Teorie i Praktyki Kultury Wizualnej">
		<meta itemprop="description" content="">
		<meta itemprop="image" content="https://www.pismowidok.org/og-image-1200x630.jpg">

		<!-- Twitter Card -->
		<meta name="twitter:card" value="summary">
		<meta name="twitter:title" content="Sammy Baloji | Widok. Teorie i Praktyki Kultury Wizualnej">
		...
		<meta property="og:title" content="Sammy Baloji | Widok. Teorie i Praktyki Kultury Wizualnej">
        ...
        <div class="c-headertools">
          <ul>
            <li class="c-headertools__lang">
							<a class="c-headertools__lang-link u-underline-border" href="/en/bio?id=1085"><span>EN</span></a>
			...
			<div class="content-canvas__inner">
				...
				<div class="c-team">
					...
					<div class="c-team__desc">
						<h1 class="c-team__title">Sammy Baloji</h1>
						<p class="c-team__meta">
							<span>
	
	
	<a target="_blank" href="http://www.imanefares.com/lartiste_contenueng.php?IDcontenu=52&IDartiste=20">http://www.imanefares.com/lartiste_contenueng.php?IDcontenu=52&IDartiste=20</a>
</span>
						</p>
						<div class="u-typo" style="margin-top: 2em;">
							<p>Urodzony w 1978 roku w Lubumbaszi w Demokratycznej Republice Konga Sammy Baloji jest fotografem i artystą wideo. Od pewnego czasu już skupia się w swojej pracy artystycznej na architektonicznym i przemysłowym dziedzictwie Katangi. Brał udział w różnych międzynarodowych wystawach, takich jak Biennale w Bamako, Biennale w Cap, oraz Tate Modern (na wystawie <em>Contested Terrains</em>). Jego wystawę indywidualną, <em>T</em><em>he Beautiful Time in Katanga</em>, prezentowało Museum of African Art w Nowym Jorku (2010) oraz Smithsonian Museum w Waszyngtonie (2012/2013). Prace Balojiego znajdują się w wielu publicznych i prywatnych instytucjach, takich jak Smithsonian, Centre National des Arts Plastiques czy Quai Branly w Paryżu, a także w Musée des Confluences w Lyon oraz Arthur Walther Collection. Przeważnie dotykają problematyki pamięci oraz konsekwencji kolonizacji.</p>
						</div>
					</div>
				</div>
