...
<html dir="ltr" lang="en-us">
	<head>
		...
		<title>Jakub Socha | View. Theories and Practices of Visual Culture</title>
		...
		<meta itemprop="name" content="Jakub Socha | View. Theories and Practices of Visual Culture">
		<meta itemprop="description" content="">
		<meta itemprop="image" content="https://www.pismowidok.org/og-image-1200x630.jpg">

		<!-- Twitter Card -->
		<meta name="twitter:card" value="summary">
		<meta name="twitter:title" content="Jakub Socha | View. Theories and Practices of Visual Culture">
		...
		<meta property="og:title" content="Jakub Socha | View. Theories and Practices of Visual Culture">
        ...
        <div class="c-headertools">
          <ul>
            <li class="c-headertools__lang">
							<a class="c-headertools__lang-link u-underline-border" href="/pl/bio?id=963"><span>PL</span></a>
			...
			<div class="content-canvas__inner">
				...
				<div class="c-team">
					...
					<div class="c-team__desc">
						<h1 class="c-team__title">Jakub Socha</h1>
						<p class="c-team__meta">
							
						</p>
						<div class="u-typo" style="margin-top: 2em;">
							<p>Born in 1983, film historian and critic. The winner of the Krzysztof Mętrak Award for film critics (2007). Co-founder of "Gazeta Filmowa". Publishes in "Kino" and "Filmweb". Co-author of the volumes: <em>Polskie kino niezależne </em>[Polish Independent Cinema] and <em>Nie chcę spać sam. Kino Tsai Ming-Lianga </em>[I Don't Want to Sleep Alone. Tsai Ming-Liang's Cinema]. He is the main editor of the cinema section in the bi-weekly online journal "D<a>wutygodnik.com"</a>.</p>
						</div>
					</div>
				</div>
